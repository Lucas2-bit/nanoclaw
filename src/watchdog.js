// watchdog.js — DEPRECATED / NEUTERED (2026-06-02, Supervisor Split keystone)
//
...
console.error('[watchdog.js] DEPRECATED: this file is neutered. Run watchdog-v2.cjs instead.');
